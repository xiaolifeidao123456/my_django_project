    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_child', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child', to='backapp.CategoryModel', verbose_name='自我关联')),
            ],
            options={
                'db_table': 't_category',
            },
        ...
        migrations.AddField(
            ...
            name='a_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='backapp.CategoryModel', verbose_name='article'),
        ),
    ]
